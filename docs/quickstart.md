...
- Fix random seeds in dataset generation and oversamplers (e.g.,
  `random_state=42`).
...
The error rate tells you what fraction of synthetic samples are more
similar to hidden majority samples than to real minority samples:
